...
public class databaseHelperMediumTen {
	...
	private static final String TABLE_MEDIUM_TENMIN = "Difficulty: Medium, Time: 10 min";
 ...
 public List<String> selectAll(String username, String score) {
    ...
    Cursor cursor = this.db.query(TABLE_MEDIUM_TENMIN, new String[] { "name", "score" }, "name = '"+ username +"' AND score= '"+ score+"'", null, null, null, "score desc");
