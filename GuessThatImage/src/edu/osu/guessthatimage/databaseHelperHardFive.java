...
public class databaseHelperHardFive {
	...
	private static final String TABLE_HARD_FIVEMIN = "Difficulty: Hard, Time: 5 min";
 ...
 public List<String> selectAll(String username, String score) {
    ...
    Cursor cursor = this.db.query(TABLE_HARD_FIVEMIN, new String[] { "name", "score" }, "name = '"+ username +"' AND score= '"+ score+"'", null, null, null, "score desc");
